...
const TestimonialItem = ({item, containerClassName}) => {
  return (
    <div
    className={clsx("px-14 relative pt-11 pb-14 after:absolute after:bottom-0 after:right-0 after:w-screen after:h-0.5 after:bg-s2 after:content-['-'] max-md:px-0 max-md:pt-11 after:max-md:-right-4",
        containerClassName
    )}
    >
     <blockquote className="h-6 mb-8 text-p4">{item.comment}</blockquote> 
